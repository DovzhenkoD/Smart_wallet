...
Одніціє з найперших дій, які потрібно зробити драйверу при створенні символьного пристрою, це отримати один або декілька номерів пристроїв для роботи з ним. Саме функція **register_chrdev_region()** виконує цю задачу. Вона знаходиться у ``#include <linux/fs.h>``.
...
.. code-block:: c
	...
	Open a device 2: 4
	Open a device 1: 3
	SOME MAGIC _write_:  Wow, we made these bees TWERK!
...
.. code-block:: c
	...
	[ 6254.466768] hivemod: New file entry 00000000d508e548 created
	[ 6254.466776] hivemod: New file entry 000000003b9bdc74 created
	[ 6254.466914] 
               Buffsize of magic = 69
	[ 6254.466918] The end of device, device has been wrtitten 31
	[ 6259.683755] 
               Buffsize of our line = 200
	[ 6268.720474] The end of device, device has been wrtitten 1
	[ 6270.202195] hivemod: File entry 00000000d508e548 unlinked
	[ 6270.202379] hivemod: File entry 000000003b9bdc74 unlinked

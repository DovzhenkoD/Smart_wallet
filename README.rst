...
**Існує 4 основних метода налаштування ядра:**
...
Також було використано функцію видалення катлогу
...
Для функціонування необхідного виводу для завантаження файлів, автоматичної очистки файлів при удаленій модулі не відбувається, ви не використовуєте відповіді тут.
